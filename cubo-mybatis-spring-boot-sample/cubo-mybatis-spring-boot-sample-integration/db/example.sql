...
(
    ...
    `status`       tinyint(4) unsigned                 not null default 0 comment '用户状态:0: 未审核, 1: 审核中, 2: 审核未通过, 3: 已锁定, 4: 正常',
...
insert into mybatis_spring_boot_sample_integration.user (id, phone, user_name, gender, nick_name, company_name, password, salt, api_key,
                                                         secret_key, email, status,
                                                         deleted, create_time, update_time)
values (1, '18628362906', 'dong4j', 1, 'dong4j', 'iHome', '000000', '000000', '000000', '000000', 'dong4j@gmail.com', 4, false,
...
insert into mybatis_spring_boot_sample_integration.rule (id, ip_from, ip_to, match_mode, name, priority, enabled, dispatch_mode,
                                                         deleted, create_time, update_time)
values (1, 2130706433, 2130706687, 'equals', 'nacos.server', 0, true, 'round-robin', false, '2019-10-09 12:01:28', '2019-10-09 13:49:37');
insert into mybatis_spring_boot_sample_integration.rule (id, ip_from, ip_to, match_mode, name, priority, enabled, dispatch_mode,
                                                         deleted, create_time, update_time)
values (2, 3232235777, 3232236031, 'equals', 'nacos.server', 0, true, 'round-robin', false, '2019-10-10 16:38:46', '2019-10-10 16:38:46');
